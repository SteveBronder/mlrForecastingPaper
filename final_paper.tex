...
\hlstd{tbats.lrn} \hlkwb{=} \hlkwd{setHyperPars}\hlstd{(}\hlkwd{makeLearner}\hlstd{(}\hlstr{"fcregr.tbats"}\hlstd{,}
                                     \hlkwc{h} \hlstd{=} \hlnum{35}\hlstd{),}
                         \hlkwc{par.vals} \hlstd{= tbatsTune}\hlopt{$}\hlstd{x)}
\hlstd{tbats.final} \hlkwb{=} \hlkwd{train}\hlstd{(lrn, climate.task)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in checkLearner(learner): object 'lrn' not found}}\end{kframe}
\end{knitrout}
\doublespacing
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{climate.pred} \hlkwb{=} \hlkwd{predict}\hlstd{(tbats.final,} \hlkwc{newdata} \hlstd{= m4.test)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in predict(tbats.final, newdata = m4.test): object 'tbats.final' not found}}\begin{alltt}
\hlkwd{performance}\hlstd{(climate.pred,} \hlkwc{measures} \hlstd{= mase,} \hlkwc{task} \hlstd{= climate.task)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in performance(climate.pred, measures = mase, task = climate.task): object 'climate.pred' not found}}\end{kframe}
\end{knitrout}
\doublespacing
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `colnames<-`(`*tmp*`, value = c("{}truth"{}, "{}response"{}, "{}forecast\_tbats"{}: length of 'dimnames' [2] not equal to array extent}}\end{kframe}
\end{knitrout}
